    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-white relative overflow-hidden">
      ...
      <div className="w-full max-w-sm animate-fade-in relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-[#475569] mt-1 text-sm">Sign in to your dashboard</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-[5px] shadow-sm p-6 sm:p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#475569]">
              Don't have an account? <Link to="/register" className="text-[#5B6EFF] hover:text-[#3F51D1] font-semibold">Create one</Link>
            </p>
          </div>
        </form>
      </div>
